...
reg add "HKCR\*\shell\SvnTimestampSave\command" /ve /t REG_SZ /d "%CMD% save \"%%1\"" /f
...
reg add "HKCR\*\shell\SvnTimestampRestore\command" /ve /t REG_SZ /d "%CMD% restore \"%%1\"" /f
...
reg add "HKCR\Directory\shell\SvnTimestampSave\command" /ve /t REG_SZ /d "%CMD% save \"%%1\"" /f
...
reg add "HKCR\Directory\shell\SvnTimestampRestore\command" /ve /t REG_SZ /d "%CMD% restore \"%%1\"" /f
